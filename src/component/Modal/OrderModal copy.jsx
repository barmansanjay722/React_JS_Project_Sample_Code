              ...
              <form className="row g-3 mt-3" onSubmit={handleSubmit}>
                ...
                <div className="col-lg-2 col-md-2 col-sm-12 typeahead">
                  ...
                  <fieldset>
                    ...
                    >
                      ...
                      <option defaultValue="MIS" disabled>
                        MIS
                      </option>
                ...
                <div className="col-lg-2 col-md-2 col-sm-12">
                  ...
                  <input
                    ...
                    id="triggerPrice"
                  />
                  {errors.triggerPrice && touched.triggerPrice && (
                    <p className="text-primary">{errors.triggerPrice}</p>
                  )}
                </div>
                {isShowPrice && (
                  <div className="col-lg-2 col-md-2 col-sm-12 float-left">
                    ...
                    {errors.price && touched.price && (
                      <p className="text-primary">{errors.price}</p>
                    )}
                  </div>
                )}
